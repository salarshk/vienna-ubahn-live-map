...
// freshness target. The Worker edge cache is one second, leaving room for a
// request and render round trip before the displayed age reaches three seconds.
export const NETWORK_SNAPSHOT_INTERVAL_MS = 1500;
