...
const CellIntelligencePanel = ({
  ...
  if (compact) return <section className="intelligence-section cell-intelligence-panel cell-intelligence-compact">
    <div className="intelligence-section-title"><Grid2X2 size={14} /><strong>200 m Vienna + NÖ grid</strong><em>Rail-corridor spatial layer</em></div>
  ...
  return <section className="intelligence-section cell-intelligence-panel">
    <div className="intelligence-section-title"><Grid2X2 size={15} /><strong>200 × 200 m Vienna + NÖ grid</strong><em>{grid.activeCells?.length || 0} active · {grid.cells.length} covered</em></div>
